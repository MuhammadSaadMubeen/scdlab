...
<head>
<title>
Inventory/Stock - Pharmacy Management System
</title>
...
$finalcode='PC-'.createRandomPassword();
?>
...
<div class="container-fluid">
	...
	<div class="contentheader">
			<i class="icon-table"></i> Inventory/Stock
			</div>
			<ul class="breadcrumb">
...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back to Dashboard</button></a>
			<?php 
			include('../connect.php');
			...
			?>
				<div style="text-align:center;">Total Number of Items in Inventory:  <font color="lightgreen" style="font:bold 22px 'Aleo';">[<?php echo $rowcount;?>]</font>
			</div>
</div>
<?php 
			include('../connect.php');
...
<!-- <br><br><form action = excel.php method = POST><input type = 'submit' name = 'submit' Value = 'Export to excel'></form></center>"; -->
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			<th width=auto> Item Code </th>
			<th width=auto> Item Name </th>
			<th width=auto> Category </th>
			<th width=auto> Supplier </th>
			<th width=auto> Date Received </th>
			<th width=auto> Expiry Date </th>
			<th width=auto> Original Price </th>
			<th width=auto> Selling Price </th>
			<th width=auto> Quantity Purchased </th>
			<th width=auto> Quantity Left </th>
	...
	<tbody>
			...
			function formatMoney($number, $fractional=false) {
				...
				echo '<tr class="alert alert-warning record" style="color: #00008B; background: #F8F8F8;">';                     
                                }
				else {
...
<br>
<form action = toexcelproducts.php method = POST><input type="submit" name = 'submit' Value = 'Export to excel' class="btn btn-info" style="float:right; width:230px; height:35px;"></form>
