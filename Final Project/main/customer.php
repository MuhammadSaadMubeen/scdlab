...
<head>
<title>
Customers Details - Pharmacy Management System
</title>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<td>PKR <?php echo $row['membership_number']; ?></td>
...
<br>
<form action = toexcelcustomers.php method = POST><input type="submit" name = 'submit' Value = 'Export to excel' class="btn btn-info" style="float:right; width:230px; height:35px;"></form>
