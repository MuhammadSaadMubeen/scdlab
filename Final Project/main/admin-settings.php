...
<head>
<title>
User Settings - Pharmacy Management System
</title>
...
<br>
<form action = toexcelusers.php method = POST><input type="submit" name = 'submit' Value = 'Export to excel' class="btn btn-info" style="float:right; width:230px; height:35px;"></form>
