<title>
Create New Invoice - Pharmacy Management System
</title>
    ...
    <div class="container-fluid">
      <div class="row-fluid">
		...
		<div class="contentheader">
			<i class="icon-money"></i> New Invoice
			</div>
			<ul class="breadcrumb">
...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: none;"><i class="icon icon-circle-arrow-left icon-large"></i> Back to Dashboard</button></a>
<a  href="sales_inventory.php"><button class="btn btn-default btn-large" style="float: right;"><i class="icon icon-circle-arrow-right icon-large"></i> Previous Invoices</button></a>
</div>
	<?php
